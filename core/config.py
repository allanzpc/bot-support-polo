...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_auto_close_response": "Ce ticket à été fermé automatiquement suite à une innactivité de {timeout}.",
        "thread_creation_response": "Mon STAFF vous répondra sous 24 heures",
        "thread_creation_footer": "Votre message à été envoyé",
        "thread_self_closable_creation_footer": "Click the lock to close the thread",
        "thread_creation_title": "Ravi de pouvoir vous aider !",
        "thread_close_footer": "Envoyez un nouveau message pour réouvrir un nouveau ticket",
        "thread_close_title": "Ravi d'avoir pu vous aider !",
        "thread_close_response": "Ce ticket d'aide est maintenant fermé. \n N'hésitez surtout pas à nous recontacter en cas de problèmes.",
        "thread_self_close_response": "Ce ticket d'aide est maintenant fermé. \n N'hésitez surtout pas à nous recontacter en cas de problèmes.",
        "thread_move_notify": False,
        "thread_move_response": "Ce ticket à été déplacé.",
        "disabled_new_thread_title": "Votre medssage n'a pas pu être envoyé...",
        "disabled_new_thread_response": "Le bot est actuellement en maintenance. \n Veuillez réessayer plus tard",
        "disabled_new_thread_footer": "Nous nous excusons pour la gène occasionnée",
        "disabled_current_thread_title": "Votre message n'a pas pu être envoyé...",
        "disabled_current_thread_response": "Le bot est actuellement en maintenance. \n Veuillez réessayer plus tard",
        "disabled_current_thread_footer": "Nous nous excusons pour la gène occasionée",
        # moderation
